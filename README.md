...
With my provided scans you can explore how many different types of data are encoded on the card (e.g., visited transit lines, dates, timestamps, card type, etc.)  It's a fun puzzle!
